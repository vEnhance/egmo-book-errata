...
\item[p.\  173] in Problem 9.3, delete the period after the centered equation.
...
\item[p.\  206] problem 10.25, change $\overline{MN}$ to just $MN$.
...
\item[p.\  229] hint 296, ``$H_A = a + b + d$'' change $H_A$ to $h_A$ for consistency.
...
\item[p.\  258] in Solution 6.35, the comma should be deleted in ``By, Lemma 6.11''.
...
\item[p.\  277] in Solution 9.49, define $L \coloneq \ol{CM} \cap \ol{A'B'}$.
...
\item[p.\  282] in Solution 10.30, change ``This solves ... $\dang A_2C_2B_2$'' to
  ...
  Similarly, we have $\dang B_3A_3C_3 = \dang B_2A_2C_2$ and $\dang C_3B_3A_3 = \dang C_2B_2A_2$.
